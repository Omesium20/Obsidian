...
Optional switches: `REDIS_URL`, `PLAID_REDIRECT_URI` (enables OAuth banks in
Link; must match a dashboard Allowed redirect URI), `WORKER_ROLE=scheduler`, `SQS_AUDIT_QUEUE_URL`,
